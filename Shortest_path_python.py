...
# trans refers to transition point between transportation methods whenever we want to find a path from source point to port using two different transportation methods. 
...
def multiple_paths(row, method1_df, both_method_df,dict_id,dict_to_trans,dict_from_trans, method2):
    """
...
def shortest_path_to_node(input_filename="Poland/Ze_points_5.0.csv", output_filename = "CSV_Distances.csv",id=7080, gridsize=5):
    ...
    for method1, method2 in methods:
        ...
        df2.apply(multiple_paths, axis=1, method1_df=method_df, both_method_df=both_methods_df,method2=method2, 
...
shortest_path_to_node("Poland/Ze_points_50.0.csv", "Fil_med_Avstand.csv",id=67, gridsize=50)
#make_contour()
